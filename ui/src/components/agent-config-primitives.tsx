...
export const help: Record<string, string> = {
  ...
  maxConcurrentRuns: "Maximum number of heartbeat runs that can execute simultaneously for this agent. New agents default to 1. Host-process adapters also share an instance-wide cap (PAPERCLIP_MAX_CONCURRENT_HOST_RUNS, default 8).",
